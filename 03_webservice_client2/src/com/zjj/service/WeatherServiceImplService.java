 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://service.zjj.com/", wsdlLocation = "http://localhost:8080/weatherService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://service.zjj.com/", "WeatherServiceImplService");
    ...
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://service.zjj.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.zjj.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
